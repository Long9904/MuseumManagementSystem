...
namespace MuseumSystem.Infrastructure.DatabaseSetting
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Convert enum Visitor.Status to string
            modelBuilder.Entity<Visitor>()
                .Property(v => v.Status)
                .HasConversion<string>();

            // ==========================
            // Artifact ↔ HistoricalContext (many-to-many)
            // ==========================
            ...
            // ==========================
            // Exhibition ↔ HistoricalContext (many-to-many)
            // ==========================
            modelBuilder.Entity<ExhibitionHistoricalContext>()
                .HasKey(eh => new { eh.ExhibitionId, eh.HistoricalContextId }); // ✅ Composite key
